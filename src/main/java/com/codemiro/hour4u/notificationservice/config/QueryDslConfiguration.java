...
public class QueryDslConfiguration {
    ...
    /**
     * Querydsl bindings factory querydsl bindings factory.
     *
     * @return the querydsl bindings factory
     */
    @Lazy
    @Bean
    ...
    /**
     * Querydsl predicate builder querydsl predicate builder.
     *
     * @return the querydsl predicate builder
     */
    @Bean
